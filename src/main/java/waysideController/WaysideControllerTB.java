...
public class WaysideControllerTB {
  ...
  @FXML public Label tbWaysideNumberLabel;
  @FXML public TableView<WaysideBlockSubject> tbBlockTable;
  @FXML public TableView<WaysideBlockSubject> tbSwitchTable;
  @FXML public TableColumn<WaysideBlockSubject, Integer> tbBTID;
  @FXML public TableColumn<WaysideBlockSubject, Boolean> tbBTOccupied;
  @FXML public TableColumn<WaysideBlockSubject, Integer> tbSTID;
  @FXML public TableColumn<WaysideBlockSubject, Integer> tbSTSwitchTo;
  @FXML public TableColumn<WaysideBlockSubject, Boolean> tbSTEnable;
  @FXML public Button tbCreateNewControllerButton;
  @FXML public ComboBox<String> tbHWPortComboBox;
  @FXML public Label tbHWPortLabel;
  @FXML public Button runPLCButton;
  ...
  private void initialize() {
    ...
    tbSTSwitchTo.setCellValueFactory(
  ...
  public void setController(WaysideControllerSubject subject) {
    ...
    if (subject.getController() instanceof WaysideControllerHWBridge) {
      tbHWPortLabel.setText(
          "HW Port: " + ((WaysideControllerHWBridge) subject.getController()).getPort());
    } else {
