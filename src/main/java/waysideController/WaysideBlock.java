...
public class WaysideBlock implements Notifier {
  ...
  public void setOccupied(boolean occupied) {
    ...
    if (subject != null) subject.notifyChange(occupied_p, occupied);
  }
  ...
  public void setBlockMaintenanceState(boolean inMaintenance) {
    ...
    if (subject != null) subject.notifyChange(inMaintenance_p, inMaintenance);
  }
  ...
  public void setSwitchState(boolean switchState) {
    ...
    if (subject != null) subject.notifyChange(switchState_p, switchState);
  }
  ...
  public void setLightState(boolean lightState) {
    ...
    if (subject != null) subject.notifyChange(lightState_p, lightState);
  }
  ...
  public void setCrossingState(boolean crossingState) {
    ...
    if (subject != null) subject.notifyChange(crossingState_p, crossingState);
  }
  ...
  public void setBooleanAuth(boolean booleanAuth) {
    ...
    if (subject != null) subject.notifyChange(authority_p, booleanAuth);
  }
