...
// This is the interface for the wayside controller, which is used to control the various track
// blocks
public interface WaysideController {
  ...
  /**
   * Sends the authority for a train to the Wayside. The authority is simply the block ID that the
   * train is allowed to travel to. This allows the Wayside to stop a train at a specific block or
   * station.
   *
