...
public class Conversion {
  ...
  public static double convertTemperature(
      double temperature, temperatureUnit from, temperatureUnit to) {
    if (from == to) {
      return temperature;
    }
  ...
  public static double convertAcceleration(
      double acceleration, accelerationUnit from, accelerationUnit to) {
    if (from == to) {
      return acceleration;
    }
