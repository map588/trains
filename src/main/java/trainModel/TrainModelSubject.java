  ...
  public void intitializeValues() {
    ...
    properties.put(
        ...
        new SimpleDoubleProperty(
            Conversion.convertMass(
                model.getMass(), Conversion.massUnits.KILOGRAMS, Conversion.massUnits.TONS)));
    properties.put(
        DISTANCETRAVELED_PROPERTY, new SimpleDoubleProperty(model.getDistanceTraveled()));
    properties.put(
        LENGTH_PROPERTY,
        new SimpleDoubleProperty(
            Conversion.convertDistance(
                model.getLength(), Conversion.distanceUnit.METERS, Conversion.distanceUnit.FEET)));
