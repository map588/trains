...
public class Properties {
    ...
    public static final String actualSpeed_p = "actualSpeed";
    public static final String acceleration_p = "acceleration";
    ...
    public static final String numCars_p = "numCars";
    public static final String numPassengers_p = "numPassengers";
    ...
    public static final String beacon_p = "beacon";
}
