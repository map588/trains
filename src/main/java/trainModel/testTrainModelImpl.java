...
public class testTrainModelImpl implements trainModel{
    ...
    public testTrainModelImpl(int trainID, trackModel track){
        ...
        this.track = track;
        this.controller = new testTrainControllerImpl(trainID);
