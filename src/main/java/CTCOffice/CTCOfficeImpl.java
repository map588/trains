...
public class CTCOfficeImpl implements CTCOffice {
    ...
    public CTCOfficeImpl() {
        ...
        CTCBlockInfo block3  = new CTCBlockInfo(3,  false, true , false, false, true ,false,       false, CROSSING_OPEN, false, false, 50,   50);
        ...
        CTCBlockInfo block6  = new CTCBlockInfo(6,  false, false, true , false, true ,LIGHT_GREEN, false, false,         true , false, 50,   50);
        ...
        CTCBlockInfo block11 = new CTCBlockInfo(11, false, false, true , false, true ,LIGHT_GREEN, false, false,         false, false, 50,   50);
