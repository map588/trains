...
/**
 * This class represents a map of CTCBlockSubjects, with each subject associated with an Integer
 * key. It extends the SubjectMap class, inheriting its methods and properties. It follows the
 * Singleton design pattern, ensuring that only one instance of this class can exist.
 *
 * @see SubjectMap
 * @see CTCBlockSubject
 */
