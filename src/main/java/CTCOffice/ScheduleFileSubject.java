...
public class ScheduleFileSubject implements AbstractSubject {
  ...
  public ScheduleFileSubject(ScheduleFile schedule) {
    properties.put(
        SCHEDULE_FILE_NAME_PROPERTY,
        new SimpleStringProperty(
            this, SCHEDULE_FILE_NAME_PROPERTY, schedule.getScheduleFileName()));
    properties.put(
        LAST_MODIFIED_PROPERTY,
        new SimpleStringProperty(this, LAST_MODIFIED_PROPERTY, schedule.getLastModified()));
    properties.put(
        NUM_TRAINS_PROPERTY,
        new SimpleIntegerProperty(this, NUM_TRAINS_PROPERTY, schedule.getNumTrains()));
