package CTCOffice.Properties;

public class BlockProperties {
    final public static String BLOCK_ID_PROPERTY = "blockID";
    final public static String LINE_PROPERTY = "line";
    public static final String OCCUPIED_PROPERTY = "occupied";
    public static final String HAS_LIGHT_PROPERTY = "hasLight";
    public static final String HAS_SWITCH_CON_PROPERTY = "hasSwitchCon";
    public static final String HAS_SWITCH_DIV_PROPERTY = "hasSwitchDiv";
