...
public class ScheduleProperties {
    public static final String TRAIN_ID_PROPERTY = "trainID";
    public static final String DISPATCH_TIME_PROPERTY = "dispatchTime";
    public static final String CAR_COUNT_PROPERTY = "carCount";
