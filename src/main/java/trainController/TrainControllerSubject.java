...
public class TrainControllerSubject implements NotifierEnum {
  private final ObservableHashMap<ControllerProperty, Property<?>> properties =
  ...
  private final TrainControllerSubjectMap controllerSubjectMap =
      TrainControllerSubjectMap.getInstance();
  ...
  private void initializeProperties() {
    ...
    properties.put(
        CURRENT_TEMPERATURE, new SimpleDoubleProperty(controller.getCurrentTemperature()));
