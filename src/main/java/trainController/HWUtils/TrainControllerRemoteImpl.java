...
/**
 * This class is the remote implementation of the TrainControllerRemote interface. It is used to
 * communicate with the TrainController Server, which is hosted by the remote device. From this
 * applications perspective, the server is the remote device.
 */
public class TrainControllerRemoteImpl extends UnicastRemoteObject
    implements TrainControllerRemote {
