...
public class CTCOfficeManagerTest extends ApplicationTest {
  ...
  public void testToggleProperty_lightState() {
    ...
    // Simulate clicking the "switchLightToggle" button to toggle the light state of the selected
    // block
    clickOn("#switchLightToggle");

    // Verify the property has been toggled - this is highly dependent on your implementation
    // details
    // For example, if toggling changes the color of a cell in the "switchLightColumn", you'd verify
    // that
    ...
    // Alternatively, if the toggle effects are visually represented, use TestFX to verify UI
    // component states
