...
/**
 * This class contains unit tests for the TrainControllerManager. It extends ApplicationTest from
 * the TestFX library to enable GUI testing.
 */
class TrainControllerManagerTest extends ApplicationTest {
  ...
  /**
   * This method sets up the testing environment. It loads the trainController.fxml file and
   * displays it in a new Stage. It also initializes the controller and currentSubject variables.
   */
  @BeforeEach
  public void setUp() {
  ...
  public void start(Stage stage) throws Exception {
    FXMLLoader loader =
        new FXMLLoader(getClass().getResource("/Framework/GUI/FXML/trainController.fxml"));
  ...
  void subjectInMapIsCorrect() {
    assertEquals(
        controller,
        TrainControllerSubjectMap.getInstance().getSubject(controllerID).getController());
  ...
  void testServiceBrakeToggle() {
    CheckBox toggleServiceBrakeCheckBox =
        lookup("#toggleServiceBrakeCheckBox").queryAs(CheckBox.class);
  ...
  /**
   * This test verifies that the internal and external light checkboxes toggle the light status in
   * the controller.
   */
  @Test
  ...
  /**
   * This test directly sets the temperature in the controller and verifies that it has been set
   * correctly.
   */
  @Test
  void directTestSetTemperature() {
    ...
    assertEquals(
        newTemperature,
        controller.getSetTemperature(),
        "The temperature should match the newly set value.");
  }

  /**
   * This test sets the temperature via the text field and verifies that it has been set correctly
   * in the controller.
   */
  @Test
  void testSetTemperatureTextField() {
    ...
    assertEquals(
        Double.parseDouble(newTemperature),
        controller.getSetTemperature(),
        "Temperature should be updated based on TextField input.");
  }
